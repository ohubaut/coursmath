...
{
document.write('<a href="javascript:Affichegrande(\''+grandeImage+'\',\''+texteImage+'\')"><img src="'+petiteImage+'" hspace=10 vspace=0 border=0 ALT="cliquez ici pour afficher en grand" align=' + pos + '></a>');
} 
